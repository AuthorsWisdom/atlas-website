      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{ fontSize: '14px', color: 'var(--text-2)', lineHeight: 2, display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <Section title="4. Subscriptions and Billing">
            <strong style={{ color: 'var(--text)' }}>Subscription Tiers:</strong> XATLAS offers Free ($0/month), Pro ($29/month), and Institutional ($79/month) subscription plans with features as described on our website.
            <br /><br />
            ...
            <br /><br />
            <strong style={{ color: 'var(--text)' }}>Free Trial:</strong> If we offer a free trial, it will automatically convert to a paid subscription at the end of the trial period unless cancelled at least 24 hours before the trial ends.
            <br /><br />
